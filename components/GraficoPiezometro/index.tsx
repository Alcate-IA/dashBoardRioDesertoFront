        ...
        return (
            <div className="chart-legend">
                {lineData.datasets.map((dataset: any) => {
                    const label = dataset.label === "Cota Superfície" && filters.tipoSelecionado === 'PR' 
                        ? "Cota" 
                        : dataset.label;
    ...
    return (
        <div className="col-12">
            ...
            <FilterBar
                ...
                onTipoFiltroChange={(value) => updateFilters({ tipoFiltroSelecionado: value })}
                ...
                <div className="chart-header">
                    <div className="chart-title">
                        {tabelaDados.length > 0 && filters.tipoSelecionado
                            ? `Dados do ${filters.tipoSelecionado === 'PP' || filters.tipoSelecionado === 'PR' ? 'Piezômetro' : 'Recurso Hídrico'}`
